        ...
        try:
            ...
            self.write_sas_log(
                ...
                details={
                    ...
                    "Pi host": self.pi_api_host or "Not configured",
                },
            )
        except Exception as e:
...
"""
    ...
    def configure_recognition_websocket(self, host: str, port: str = "5000", start: bool = False):
        ...
        try:
            self.websocket_client_service.configure(host, port or "5000")
    ...
    def handle_websocket_disconnected(self, reason: str = "disconnected"):
        if getattr(self, "is_locked", False):
            self.append_system_log(f"WebSocket unlock channel disconnected: {reason}")
