...
public sealed partial class JabilEyeReconnectWindow : Window
{
    ...
    public JabilEyeReconnectWindow(string hostname, bool locked)
    {
        InitializeComponent();
        ConfigureWindow();
    ...
    public void ShowDisconnected(string hostname, string error, bool locked)
    {
        ...
        TitleTextBlock.Text = alreadyOwned ? "JabilEye already in use" : "JabilEye disconnected";
        HostTextBlock.Text = alreadyOwned
            ...
            : string.IsNullOrWhiteSpace(hostname)
                ? "Please restart JabilEye."
                : $"Please restart \"{hostname}\".";
        MessageTextBlock.Text = alreadyOwned
            ? "Only one SAS workstation can own JabilEye at a time. Close or disconnect the current SAS connection, then retry."
            : locked
                ...
                : "SAS cannot reach JabilEye. Keep this window open and restart or reconnect JabilEye. The camera preview will resume automatically.";
    ...
    public void ShowConnected(bool locked)
    {
        ...
        TitleTextBlock.Text = "JabilEye connected";
    ...
    {
        Title = "SAS JabilEye Connection";
        AppWindow.Title = "SAS JabilEye Connection";
